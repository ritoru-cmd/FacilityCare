    ...
    <nav class="bg-white shadow-sm">
        <div class="max-w-7xl mx-auto px-6 h-16 flex justify-between items-center">
            ...
            <div class="flex items-center gap-3">
                ...
                <div
                    class="w-10 h-10 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 flex items-center justify-center text-white font-bold">
        ...
        <div class="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
                ...
                <p class="text-gray-600 text-lg mt-6">
                    ...
                    Laporkan kerusakan fasilitas kampus secara cepat,
                    pantau progres perbaikan, dan bantu menjaga
        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="text-center">
                    ...
                    <p class="text-gray-500 mt-2">
                        Pengguna melaporkan kerusakan fasilitas.
                    </p>
                ...
                <div class="text-center">
                    ...
                    <p class="text-gray-500 mt-2">
                        Admin melakukan verifikasi dan perbaikan.
                    </p>
                ...
                <div class="text-center">
                    ...
                    <p class="text-gray-500 mt-2">
                        Status laporan diperbarui secara realtime.
                    </p>
